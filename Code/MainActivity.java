        ...
        public void onWindowFocusChanged(boolean hasFocus) {
            ...
            if (hasFocus) {
                ...
                if ((prevsWidth != sWidth) || (prevsHeight != sHeight)) { // If orientation changed
                    ...
                    if (heightRatio > 1)
                        heightRatio = 0.7 f * heightRatio;
                    else
                        heightRatio = heightRatio / 0.7 f;
                    ...
                    startButton.setTextSize(TypedValue.COMPLEX_UNIT_PX, 0.8 f * heightRatio * startButton.getTextSize());
                    createButton.setTextSize(TypedValue.COMPLEX_UNIT_PX, 0.8 f * heightRatio * createButton.getTextSize());
